...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Rendering surface normals on a sphere" {11,17-21,25-28}
    mod color;
    mod ray;
    mod vec3;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Rendering surface normals on a sphere" {7,13-17,21-24,28}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | The new main() with Hittables" {2-4,6,12-13,15,18-21,35-40,67}
    mod color;
    mod common;
    mod hittable;
    mod hittable_list;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | The new main() with Hittables" {4-6,8,11-14,18,28-33,57}
    #include <iostream>
