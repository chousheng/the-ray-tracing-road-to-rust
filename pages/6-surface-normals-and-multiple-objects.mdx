...
<Fig caption="Sphere surface-normal geometry" src="fig-1.05-sphere-normal.jpg" label="sphere-normal" />
...
<Fig caption="Possible directions for sphere surface-normal geometry" src="fig-1.06-normal-sides.jpg" label="normal-sides" />
...
We now add a `HitableList` struct that stores a list of `Hittable` trait objects.
...
<Img caption="Resulting render of normals-colored sphere with ground" src="img-1.05-normals-sphere-ground.png" />
