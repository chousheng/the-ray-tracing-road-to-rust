...
```rust filename="sphere.rs | Using Option in Sphere struct" {25}
use std::sync::Arc;
...
```rust filename="material.rs | Using Option in Material structs" {26,34-37,56,59-66,90,110-113}
use crate::color::Color;
use crate::hittable::HitRecord;
use crate::ray::Ray;
use crate::{common, vec3};
...
```rust filename="main.rs | Using Option in ray_color()" {18,31-33}
mod camera;
mod color;
mod common;
mod hittable;
