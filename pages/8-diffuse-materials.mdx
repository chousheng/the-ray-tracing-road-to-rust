...
<Fig caption="Light ray bounces" src="fig-1.08-light-bounce.jpg" label="light-bounce" />
...
<Fig caption="Generating a random diffuse bounce ray" src="fig-1.09-rand-vec.jpg" label="rand-vec" />
...
<Img caption="First render of a diffuse sphere" src="img-1.07-first-diffuse.png" />
...
<Img caption="Diffuse sphere with gamma correction" src="img-1.08-gamma-correct.png" />
...
<Fig caption="Generating a random unit vector" src="fig-1.10-rand-unitvec.png" label="rand-unitvec" />
...
<Img caption="Correct rendering of Lambertian spheres" src="img-1.09-correct-lambertian.png" />
