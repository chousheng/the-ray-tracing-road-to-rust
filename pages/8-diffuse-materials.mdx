...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | Vec3 random utility functions"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | The random_in_unit_sphere() function"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() using a random ray direction"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with depth limiting"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="color.rs | write_color(), with gamma correction"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Calculating reflected ray origins with tolerance"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | The random_unit_vector() function"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with replacement diffuse"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | The random_in_hemisphere(normal) function"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with hemispherical scattering"
    ```
  </Tab>
