...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with depth limiting" {19-24,29,44,68}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | ray_color() with depth limiting" {11-16,21,36,60}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="color.rs | write_color(), with gamma correction" {14,16-18}
    use std::io::Write;
  ...
  <Tab label="C++">
    ```cpp filename="color.h | write_color(), with gamma correction" {17,19-21}
    #ifndef COLOR_H
    #define COLOR_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with replacement diffuse" {28}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | ray_color() with replacement diffuse" {20}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | The random_in_hemisphere(normal) function" {176-185}
    use std::fmt::{Display, Formatter, Result};
    use std::ops::{Add, AddAssign, Div, DivAssign, Mul, MulAssign, Neg, Sub};
  ...
  <Tab label="C++">
    ```cpp filename="vec3.h | The random_in_hemisphere(normal) function" {145-154}
    #ifndef VEC3_H
    #define VEC3_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | ray_color() with hemispherical scattering" {28}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | ray_color() with hemispherical scattering" {20}
    #include <iostream>
