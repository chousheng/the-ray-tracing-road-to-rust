...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | Generate random point inside unit disk"
    ```
  </Tab>

  <Tab label="C++">
    ```cpp filename="vec3.h | Generate random point inside unit disk"
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="camera.rs | Camera with adjustable depth-of-field (dof)"
    ```
  </Tab>

  <Tab label="C++">
    ```cpp filename="camera.h | Camera with adjustable depth-of-field (dof)"
        class camera {
            public:
                camera(
                    point3 lookfrom,
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene camera with depth-of-field"
    ```
  </Tab>

  <Tab label="C++">
    ```cpp filename="main.cpp | Scene camera with depth-of-field"
