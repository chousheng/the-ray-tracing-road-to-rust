...
<Tabs>
  <Tab label="Rust">
    ```rust filename="hittable.rs | HitRecord with added Material pointer" {1-3,11}
    use std::rc::Rc;
  ...
  <Tab label="C++">
    ```cpp filename="hittable.h | HitRecord with added Material pointer" {3-4,8-9,21}
    #ifndef HITTABLE_H
    #define HITTABLE_H
...
<Tabs>
  ...
  <Tab label="C++">
    ```cpp filename="vec3.h | The vec3::near_zero() method" {73-78}
    #ifndef VEC3_H
    #define VEC3_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Metal Material with reflectance function" {46-70}
    use crate::color::Color;
    use crate::hittable::HitRecord;
    use crate::ray::Ray;
    use crate::vec3;
  ...
  <Tab label="C++">
    ```cpp filename="material.h | Metal Material with reflectance function" {7,46-65}
    #ifndef MATERIAL_H
    #define MATERIAL_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Ray color with scattered reflectance" {6,28-39}
    mod camera;
    mod color;
    mod common;
    mod hittable;
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with metal spheres" {12,18,61-86}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with metal spheres" {45-53}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Metal Material fuzziness" {49,53-57,70}
    use crate::color::Color;
    use crate::hittable::HitRecord;
    use crate::ray::Ray;
    use crate::vec3;
  ...
  <Tab label="C++">
    ```cpp filename="material.h | Metal Material fuzziness" {49,58,65}
    #ifndef MATERIAL_H
    #define MATERIAL_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Metal spheres with fuzziness" {64-65}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Metal spheres with fuzziness" {47-48}
    #include <iostream>
