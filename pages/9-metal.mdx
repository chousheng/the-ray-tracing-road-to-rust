...
```cpp filename="hittable.h | Hit record with added material pointer"
    #include "rtweekend.h"
...
```cpp filename="main.cc | Ray color with scattered reflectance"
...
```cpp filename="main.cc | Scene with metal spheres"
    ...
