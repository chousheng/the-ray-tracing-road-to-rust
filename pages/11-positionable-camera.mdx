...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with wide-angle camera" {18,60,63-64,67-68,72-73,79}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with wide-angle camera" {44,46,47-51,55}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with alternate viewpoint" {18,21,59,62-65,68-84,88-89,95-101}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with alternate viewpoint" {43,46-49,51-55,59-65}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Change field of view" {99}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Change field of view" {59-61}
    #include <iostream>
    ...
    int main() {
        ...
        Camera
            cam(Point3(-2.0, 2.0, 1.0), Point3(0.0, 0.0, -1.0), Vec3(0.0, 1.0, 0.0), 20.0, ASPECT_RATIO
            );
