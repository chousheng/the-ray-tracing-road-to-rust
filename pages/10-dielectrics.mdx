...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | Refraction function"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Dielectric Material struct that always refracts"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Changing left and center spheres to glass"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Dielectric Material struct with reflection"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with dielectric and shiny sphere"
    ```
  </Tab>

  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with dielectric and shiny sphere"
        auto material_ground = make_shared<lambertian>(color(0.8, 0.8, 0.0));
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Full glass material"
    ```
  </Tab>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with hollow glass sphere"
    ```
  </Tab>

  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with hollow glass sphere"
