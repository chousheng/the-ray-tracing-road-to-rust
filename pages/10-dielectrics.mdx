...
<Fig caption="Ray refraction" src="fig-1.13-refraction.jpg" label="refraction" />
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="vec3.rs | Refraction function" {186-192}
  ...
  <Tab label="C++">
    ```cpp filename="vec3.h | Refraction function" {155-161}
    #ifndef VEC3_H
    #define VEC3_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Dielectric Material struct that always refracts" {76-110}
  ...
  <Tab label="C++">
    ```cpp filename="material.h | Dielectric Material class that always refracts" {68-91}
    #ifndef MATERIAL_H
    #define MATERIAL_H
...
<Img caption="Glass sphere that always refracts" src="img-1.14-glass-always-refract.png" />
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Dielectric Material struct with reflection" {104-112,115}
    use crate::color::Color;
    use crate::hittable::HitRecord;
    use crate::ray::Ray;
    use crate::vec3;
  ...
  <Tab label="C++">
    ```cpp filename="material.h | Dielectric Material class with reflection" {82-87,90}
    #ifndef MATERIAL_H
    #define MATERIAL_H
    ...
    public:
        ...
        bool scatter( //
            ...
            auto direction = cannot_refract ? reflect(unit_direction, rec.normal)
...
<Img caption="Glass sphere that sometimes refracts" src="img-1.15-glass-sometimes-refract.png" />
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Full glass material" {4,87-93,115-117}
    use crate::color::Color;
    use crate::hittable::HitRecord;
    use crate::ray::Ray;
  ...
  <Tab label="C++">
    ```cpp filename="material.h | Full glass material" {86-89,97-103}
    #ifndef MATERIAL_H
    #define MATERIAL_H
...
<Img caption="A hollow glass sphere" src="img-1.16-glass-hollow.png" />
