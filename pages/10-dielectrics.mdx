...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Changing left and center spheres to glass" {18,63-64}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Changing left and center spheres to glass" {46-47}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with dielectric and shiny sphere" {63,65}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with dielectric and shiny sphere" {46,48}
    #include <iostream>
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="material.rs | Full glass material" {2,87-93,115-117}
    use crate::color::Color;
    use crate::common;
    use crate::hittable::HitRecord;
    use crate::ray::Ray;
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Scene with hollow glass sphere" {80-84}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Scene with hollow glass sphere" {53}
    #include <iostream>
