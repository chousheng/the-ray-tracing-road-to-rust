...
<Tabs>
  ...
  <Tab label="C++">
    ```cpp filename="common.h | The clamp() utility function" {20-21,30-39}
    #ifndef COMMON_H
    #define COMMON_H
...
<Tabs>
  <Tab label="Rust">
    ```rust filename="main.rs | Rendering with multi-sampled pixels" {1,12,18,37,47,56-63}
    mod camera;
    mod color;
    mod common;
    mod hittable;
  ...
  <Tab label="C++">
    ```cpp filename="main.cpp | Rendering with multi-sampled pixels" {3,29,39,48-55}
    #include <iostream>
