...
<Callout emoji="🦀">
  By default, Cargo build and run the program in debug mode, which may be slow. Try use `cargo run --release` to build and run in release mode. It will be much faster.
</Callout>
