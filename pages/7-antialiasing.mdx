...
```cpp filename="rtweekend.h | random_double() functions"
    #include <cstdlib>
    ...
...
```cpp filename="rtweekend.h | random_double(), alternate implemenation"
    #include <random>
...
```cpp filename="rtweekend.h | The clamp() utility function"
