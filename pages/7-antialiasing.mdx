...
<Callout emoji="🦀">
  By default, Cargo builds and runs the program in debug mode, which may be slow. Try using `cargo run --release` to build and run in release mode. It will be much faster.
</Callout>
