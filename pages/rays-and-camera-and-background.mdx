...
```rust filename="ray.rs (The ray struct)"
...
```rust filename="main.rs (Rendering a blue-to-white gradient)" {2,8-15,20-36,45-51}
mod color;
mod ray;
mod vec3;
...
```cpp filename="main.cpp (Rendering a blue-to-white gradient)" {4-11,16-30,39-45}
#include <iostream>
